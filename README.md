...
2. **内层拆解 (`s00_evolution` 目录)**：为了真正搞透 Agent 的底层逻辑，决定回归“慢就是快”的原则，基于 [HKUDS/OpenHarness](https://github.com/HKUDS/OpenHarness) 的源码，将其核心能力自主拆分为约 12 个循序渐进的模块来进行“造轮子”式的复刻学习。带你深度理解大模型应用开发是如何从“提示词工程”一步步演进到为大模型“造整车”的“Harness 工程”阶段的。
